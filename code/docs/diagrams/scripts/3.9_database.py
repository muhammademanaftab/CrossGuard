"""Sub-diagram: Database Layer (Section 3.9) -- compact and professional."""

import graphviz


def cn(name, attrs=None, methods=None):
    header = f"<b>{name}</b>"
...
def build():
    ...
    g.node('BrowserResult', cn('BrowserResult',
        ['+ id : int', '+ browser : str',
         '+ version : str', '+ support_status : str'],
        ['+ to_dict() : Dict']))
