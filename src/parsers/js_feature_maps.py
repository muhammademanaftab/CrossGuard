...
AST_SYNTAX_NODE_MAP = {
    ...
    'generator_function_declaration': 'es6-generators',
...
AST_MEMBER_EXPRESSION_MAP = {
    ...
    'navigator.getVRDisplays': 'webvr',
    'navigator.mediaDevices': 'streams',
    'crypto.subtle': 'cryptography',
    'crypto.getRandomValues': 'getrandomvalues',
    'screen.orientation': 'screen-orientation',
    'document.fonts': 'font-loading',
    'document.head': 'documenthead',
    'document.hidden': 'pagevisibility',
    'document.visibilityState': 'pagevisibility',
    ...
    'document.featurePolicy': 'feature-policy',
    ...
    'document.createRange': 'dom-range',
    'window.matchMedia': 'matchmedia',
    'window.getSelection': 'selection-api',
    'window.postMessage': 'x-doc-messaging',
    ...
    'performance.timing': 'nav-timing',
    'performance.navigation': 'nav-timing',
    'CSS.supports': 'css-supports-api',
    'CSS.paintWorklet': 'css-paint-api',
    ...
    'Number.isNaN': 'es6-number',
    'Number.isFinite': 'es6-number',
    'Number.parseInt': 'es6-number',
    'JSON.parse': 'json',
    'JSON.stringify': 'json',
    ...
    'URL.createObjectURL': 'bloburls',
    'WebAssembly.instantiate': 'wasm',
    'WebAssembly.compile': 'wasm',
    'Reflect.apply': 'es6',
    'Reflect.construct': 'es6',
    'Symbol.iterator': 'es6',
    'Atomics.wait': 'wasm-threads',
...
AST_IDENTIFIER_MAP = {
    ...
    'PasswordCredential': 'credential-management',
    'KeyframeEffect': 'web-animation',
    ...
    'HTMLPortalElement': 'portals',
    'HTMLFormElement': 'forms',
    'DeviceOrientationEvent': 'deviceorientation',
    'DeviceMotionEvent': 'deviceorientation',
    'PointerEvent': 'pointer',
    'TouchEvent': 'touch',
    'XPathResult': 'document-evaluate-xpath',
    'WebGLRenderingContext': 'webgl',
    'WebGL2RenderingContext': 'webgl2',
    'OrientationSensor': 'orientation-sensor',
    'AbsoluteOrientationSensor': 'orientation-sensor',
