"""Project overview stats card -- framework badge, file counts, minified warnings."""
...
class ProjectStatsCard(ctk.CTkFrame):
    ...
    def _init_ui(self):
        ...
        # Only packed when TypeScript is detected

        # Only packed when minified files found
    ...
    def update_stats(
        ...
        """Refresh the displayed project stats."""
